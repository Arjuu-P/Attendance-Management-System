...
<div class="text-center mb-5">
    <h1 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;" style="background-color:#b3b3b3;">REGISTER AS trainer</h1>
    </div>
    ...
    <form id="submitForm" action="" method="POST">
                            ...
                            <div class="form-group required">
                                    <lSabel for="username">Please choose Your Teaching Course</lSabel>
